...
| transaction history [page:#] [world:name/all] | tne.transaction.history | See a detailed break down of your transaction history. Page ~ The page number you wish to view. World ~ The world name you wish to filter, or all for every world. Defaults to current world. |
